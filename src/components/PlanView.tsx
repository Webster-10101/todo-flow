    ...
    <div className="space-y-6">
      <div
        className={[
          ...
          pastCutoff ? "border-red-200 bg-red-50" : "border-emerald-200 bg-emerald-50",
        ].join(" ")}
      >
        <div className={["text-sm", pastCutoff ? "text-red-900" : "text-emerald-900"].join(" ")}>
          {pastCutoff
        ...
        {queuedSprint.length ? (
          <TaskList
            ...
            renderAfterRow={(parent) => {
              ...
              return (
                <div className="mt-2 ml-3 sm:ml-6 space-y-2 min-w-0">
                  {kids.length ? (
